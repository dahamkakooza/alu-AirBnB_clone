...
class TestBaseModel_instantiation(unittest.TestCase):
    ...
    def test_str_representation(self):
        # 1. re creating a datetime object.
        # 2. re creating a BaseModel object.
        # 3. re setting the id, created_at, and updated_at,
        # attributes of the BaseModel object.
        # 4. re calling the __str__ method of the BaseModel object.
        # 5. re checking that the output of the __str__ method,
        # contains the id, created_at, and updated_at attributes.
        dt = datetime.today()
        dt_repr = repr(dt)
        bm = BaseModel()
        bm.id = "123456"
    ...
    def test_instantiation_with_args_and_kwargs(self):
        ...
        # 3. We create a BaseModel object with the  and,
        # the created_at and updated_at attributes set to the ISO 8601 string.
        # 4. We check that the id attribute is set .
        # 5. We check that the created_at attribute is set to,
        # the datetime object.
        # 6. We check that the updated_at attribute is set to,
        # the datetime object.
        dt = datetime.today()
        dt_iso = dt.isoformat()
